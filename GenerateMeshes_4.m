...
for id=0:4
MeshName="Mesh_Steep_5/versionfour_steeper_L_"+num2str(id);
...
PathNodes="Mesh_Steep_5/Julia/"+"Nodes_L_"+num2str(id)+".txt";
PathElements="Mesh_Steep_5/Julia/"+"Elements_L_"+num2str(id)+".txt";
 
dlmwrite(PathNodes,Point,'delimiter',' ','precision',15)
dlmwrite(PathElements,El,'delimiter',' ','precision',15)

PathNodes="Mesh_Steep_5/Matlab/"+"Nodes_L_"+num2str(id)+".txt";
PathElements="Mesh_Steep_5/Matlab/"+"Elements_L_"+num2str(id)+".txt";
