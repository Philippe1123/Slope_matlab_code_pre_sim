...
Plane Surface(5) = {5};
//+
Characteristic Length {1, 2, 7, 8} = 2.0;
//+
Characteristic Length {2, 3, 6, 7} = 2.0;
//+
Characteristic Length {3, 4, 5, 6} = 2.0;
//+
Characteristic Length {6, 5, 9, 10} = 2.0;
//+
Characteristic Length {7, 6, 10, 11} = 0.7;
