...
for id=0:7
MeshName="Mesh_Steep/versionthree_Coarse_steeper_L_"+num2str(id);
...
PathNodes="Mesh_Steep/Julia/"+"Nodes_L_"+num2str(id)+".txt";
PathElements="Mesh_Steep/Julia/"+"Elements_L_"+num2str(id)+".txt";
 
dlmwrite(PathNodes,Point,'delimiter',' ','precision',15)
dlmwrite(PathElements,El,'delimiter',' ','precision',15)

PathNodes="Mesh_Steep/Matlab/"+"Nodes_L_"+num2str(id)+".txt";
PathElements="Mesh_Steep/Matlab/"+"Elements_L_"+num2str(id)+".txt";
